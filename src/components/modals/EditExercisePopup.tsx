                ...
                <div className="mt-4 space-y-3">
                  ...
                  {adjustmentUnit === 'kg' && (
                    <p className="text-sm text-gray-500 text-center">
                      {adjustmentType === 'increase' ? 'Aumentará' : 'Disminuirá'} {weightAdjustment ? `${Number(weightAdjustment)} kg` : '0 kg'}
                    </p>
                  )}
                  {adjustmentUnit === 'percentage' && (
                    <p className="text-sm text-gray-500 text-center">
                      {adjustmentType === 'increase' ? 'Aumentará' : 'Disminuirá'} {weightAdjustment ? `${(calculatedRM * (Number(weightAdjustment) / 100)).toFixed(1)} kg` : '0 kg'}
                    </p>
                  )}
                </div>
              )}
